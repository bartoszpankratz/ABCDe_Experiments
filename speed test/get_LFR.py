#!/usr/bin/env python
# coding: utf-8
# gen_LFR.py n gamma min_deg E_deg degs beta coms mu xi path seed
import sys
import os.path
...
logname = "logs/LFR_" + str(n) + "_" + str(xi) + "_" + str(beta) + "_" + str(gamma) + "_" + str(min_deg) + ".log"
LFRname = res_dir + "/LFR_" + str(n) + "_" + str(xi) + "_" + str(beta) + "_"  + str(gamma) + "_" + str(min_deg) + ".dat"
...
try:
    ...
    res = [n, xi, mu, beta, gamma, min_deg, E_deg, n_edges, "NaN", 1, time]
