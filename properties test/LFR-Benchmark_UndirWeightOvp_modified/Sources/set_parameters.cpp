...
class Parameters {
	...
	public:
        ...
        string nameDegreeSeq;
        string nameCommunitySeq;
...
Parameters::Parameters() {
        ...
        nameDegreeSeq = "degree_seq.dat";
        nameCommunitySeq = "community_seq.dat";
        ...
        command_flags.push_back("-dname");		//15
        command_flags.push_back("-cname");		//16
		command_flags.push_back("-name");		//17
		command_flags.push_back("-seed");		//18
...
bool Parameters::set(string & flag, string & num) {
	...
	if(flag != command_flags[15] && flag != command_flags[16]
       && flag != command_flags[17] && flag != command_flags[18]
